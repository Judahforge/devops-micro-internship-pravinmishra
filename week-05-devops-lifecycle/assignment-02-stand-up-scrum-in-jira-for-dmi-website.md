...
![Space confirmation](./screenshots/jira_space1.png)
...
![Backlog showing the Epic panel enabled and the Epic visible](./screenshots/epic-panel.png)
...
![Backlog showing the Epic and all six Stories under it](./screenshots/epic_list.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![One opened Story showing](./screenshots/story.png)
...
![S2 showing all four Sub-tasks](./screenshots/subtask1.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![S4 showing all four Sub-tasks](./screenshots/subtast2.png)
...
![Backlog or Story details showing labels](./screenshots/filter.png)
...
![Sprint 1 before starting, showing the selected Stories and Story Points](./screenshots/sprint.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active Sprint board showing the started Sprint and Sprint Goal](./screenshots/start-sprint.png)
...
![frontend showing the filtered results](./screenshots/frontend-filter.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![devops showing the filtered results](./screenshots/Devops-filter.png)
...
![Burndown Chart page opened for Sprint 1](./screenshots/sprint-burndown-chart.png)
