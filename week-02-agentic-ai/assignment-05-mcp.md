...
![GitHub token](./screenshots/PAT.png)
...
![.mcp.json](./screenshots/mcp.json.png)
...
![settings.local.json](./screenshots/setting.png)
...
![github: connected](./screenshots/gitconnected.png)
...
![Claude's response](./screenshots/gitintaract.png)
